...
@AllArgsConstructor
@Slf4j
public class BankAccountServiceImpl implements  BankAccoutService{

    private CustomerRepository customerRepository;
    private BankRepository bankAccountRepository;
    private BankOpperationRepository accountOperationRepository;
    ...
    @Override
    public void debit(String account, double amount, String description) throws BankAccountNotFoundException, BalanceNotSufficientException {
        BankAccount bankAccount=bankAccountRepository.findById(account)
                .orElseThrow(()->new BankAccountNotFoundException("BankAccount not found"));
    ...
    @Override
    public void credit(String account, double amount, String description) throws BankAccountNotFoundException {
        BankAccount bankAccount=bankAccountRepository.findById(account)
                .orElseThrow(()->new BankAccountNotFoundException("BankAccount not found"));
        AccountOperation accountOperation=new AccountOperation();
